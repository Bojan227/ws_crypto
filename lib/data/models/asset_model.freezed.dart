...
/// @nodoc
@JsonSerializable()
class _$AssetDtoImpl with DiagnosticableTreeMixin implements _AssetDto {
  const _$AssetDtoImpl(final List<Map<String, dynamic>> data) : _data = data;
...
abstract class _AssetDto implements AssetDto {
  const factory _AssetDto(final List<Map<String, dynamic>> data) =
      _$AssetDtoImpl;
